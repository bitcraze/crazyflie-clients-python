...
from ui.widgets.plotwidget import PlotWidget
from ui.widgets.rtplotwidget import PlotDataSet
...
class PlotTest(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.cosDataSet = PlotDataSet("Graph showing cos", QtCore.Qt.black, [180, -180])
        self.sinDataSet = PlotDataSet("One showing sin", QtCore.Qt.blue, [180, -180])
        self.negcosDataSet = PlotDataSet("Another one showing -cos", QtCore.Qt.green, [180, -180])
        self.negsinDataSet = PlotDataSet("And the last one showing -sin", QtCore.Qt.magenta, [180, -180])
